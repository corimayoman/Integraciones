...
const DICTIONARIES = {
  en: {
    ...
    'compliance.noTasksInFilter':   'No tasks in this category.',
    ...
    'compliance.colSeverity':   'Severity',
    'compliance.gistLabel':         'GIST Internal Infrastructure',
    'compliance.internalLabel':     'Internal Infrastructure',
    'compliance.externalLabel':     'External Infrastructure',
    'compliance.soxInfraLabel':     'SOX Infrastructure',
    'compliance.showTasks':     'Show tasks ({n})',
    'compliance.vulns':         'Critical and High vulnerabilities · {total} total',
    'compliance.taskCount':     '{total} tasks',
    ...
    'compliance.remindDisabled':   'Connect to Jira to send reminders',
    'compliance.escalate':         'Escalate',
    'compliance.escalateTitle':    'Send an overdue escalation comment requesting a contingency plan and new commitment date',
    'compliance.escalateSending':  'Sending…',
    'compliance.escalateSent':     'Sent ✓',
    'compliance.escalateError':      'Failed',
    'compliance.escalateNotOverdue': 'Only available for overdue tasks',
    ...
    'sox.relatedIssues':        'Related issues',
  ...
  es: {
    ...
    'compliance.noTasksInFilter':   'No hay tareas en esta categoría.',
    ...
    'compliance.colSeverity':   'Severidad',
    'compliance.gistLabel':         'GIST Infraestructura Interna',
    'compliance.internalLabel':     'Infraestructura Interna',
    'compliance.externalLabel':     'Infraestructura Externa',
    'compliance.soxInfraLabel':     'Infraestructura SOX',
    'compliance.showTasks':     'Ver tareas ({n})',
    'compliance.vulns':         'Vulnerabilidades críticas y altas · {total} total',
    'compliance.taskCount':     '{total} tareas',
    ...
    'compliance.remindDisabled':   'Conectá a Jira para enviar recordatorios',
    'compliance.escalate':         'Escalar',
    'compliance.escalateTitle':    'Enviar un aviso de vencimiento solicitando un plan de contingencia y nueva fecha de compromiso',
    'compliance.escalateSending':  'Enviando…',
    'compliance.escalateSent':     'Enviado ✓',
    'compliance.escalateError':      'Error',
    'compliance.escalateNotOverdue': 'Solo disponible para tareas vencidas',
    ...
    'sox.relatedIssues':        'Issues relacionados',
    ...
    'admin.searchPlaceholder':  'Buscar por email…',
    'admin.searchResults':      '{n} de {total} usuarios',
    'admin.userCount':          '{n} usuarios',
    'admin.pageOf':             'Página {page} de {total}',
    'admin.colEmail':           'Email',
    'admin.colRole':            'Rol',
    'admin.colSections':        'Secciones',
